/**
 * Created by littlehui on 2019/8/5.
 */
var Gitmint =
        ...
        var Gitment = function () {
            ...
            function Gitment() {
                ...
                if (query.code) {
                    ...
                    var logging = !proxy_gateway ? _utils.http.post('http://oauth.lilhui.com', { code: code, client_id: client_id, client_secret: client_secret }, '') : _utils.http.post('/login/oauth/access_token', 'code=' + code + '&client_id=' + client_id, proxy_gateway);
